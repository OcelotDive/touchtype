...
class TextArea extends Component {
	...
	render() {
		...
		let lesson21;
		if(this.props.flagSelect1 === 'usLayout flagHighlighted'){
			lesson21 = shuffle(["*.ei", "iIqP3", '-_=qi', "<\\3/g", "Hh/.", "Qiu8[", ",#ˋ", "1&s%", "^ip+", "+Gg|", "e'Ez}", "Bc)A!", "#V", "0=kK;", "fS~|\|", 'P"hn#', "gm*,R5$", 'we%', "y@qG", "hir", "e,9", "#:d2", "wi1!2", "Z?82c", "/0G*", "H*(U)", "bnj)&*", "@'kj7", "TK>/", ">sw", ")JG76", "mcnvb74", "dui_=64", "~;j57", "MN", ".jf93.", "9G", "|F6", "$y{gdr}", "09uh(", "j8t", "9!hlr", "JQWin", "^YT@h", "I7Pu", "U(!wzc", "tTˋ9ˋnZ"]);
		}
		else {
			lesson21 = shuffle(["*.ei", "iIqP3", '-_=qi', "<\\3/g", "Hh/.", "Qiu8[", ",#ˋ", "1&s%", "^ip+", "+Gg|", "e'Ez}", "Bc)A!", "#¬V", "0=kK;", "fS~|\|", 'P"hn#', "gm*,R5$", 'we%', "y@qG¬", "hir", "e,9£", "#:d2", "wi1!2", "Z?82c", "/0G*", "H*(U)", "bnj)&*", "@'kj7", "TK>/", ">£sw", ")JG76", "mcnvb74", "dui_=64", "~;j57", "MN", ".jf93.", "9G", "|F6", "$y{gdr}", "09uh(", "¬j8t", "9!hlr", "JQWin", "^YT@h", "I7Pu", "U(!wzc", "tTˋ9ˋnZ"]);	
		}
